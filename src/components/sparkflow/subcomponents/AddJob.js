  ...
  return (
    <div>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
          Create a new recurring job that can be run either via triggers or on a scheduled basis.
          </DialogContentText>
          <FormGroup row>
            <FormControlLabel
              control={
        ...
        <DialogActions>
          ...
          <Submit auth={props.auth} text={"Register"} payload={prepareCreatePayload(values)} resource={"job"} />
        </DialogActions>
      </Dialog>
    </div>
  );
